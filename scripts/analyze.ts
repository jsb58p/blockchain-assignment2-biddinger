...
const HASHES = {
tx1: "0x5e983d095a7f44fc64a7fa3d26f48c95c7e56626eb5558b4eacea7f7cb422f5d",
tx2: "0xee3ddd33e2a799fd032fc8469decfbb275e1dff220c9b8c543f35fcbbadb6624",
tx3: "0xdf05f0b8b30e2b490fa29aa84f3c0fea05ed2ac529978b27a111eaa1bf569214",
};
...
console.log(`\n=== ${hash} ===`);
console.log("Status:", rcpt.status === "success" ? "Success" :
"Fail");
console.log("Block:", rcpt.blockNumber);
console.log("Timestamp (UTC):", new
Date(Number(block.timestamp) * 1000).toISOString());
...
for (const log of rcpt.logs) {
  try {
    const parsed = decodeEventLog({ abi, data: log.data, topics: log.topics }) as {
      eventName: string;
